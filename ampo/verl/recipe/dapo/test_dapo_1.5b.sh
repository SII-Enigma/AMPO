...
project_name='DAPO'
exp_name='DAPO-Qwen2.5-1.5b-test'
...
MODEL_PATH="/data1/models/Qwen2.5-1.5B-Instruct"
CKPTS_DIR="/data1/RL_output/Qwen2.5-1.5B/checkpoints/${project_name}/${exp_name}"
TRAIN_FILE="/data/RLAMG/data/openr1_multi_longcot_pr.parquet"
TEST_FILE="/data/RLAMG/data/valid_math_all.parquet"
