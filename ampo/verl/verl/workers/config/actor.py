...
class ActorConfig(BaseConfig):
    ...
    off_policy_max_clip: int = -1
    off_policy_min_clip: int = -1
    ...
    use_adaptive_temperature_fixed: bool = False
    adaptive_temperature_clip: int = -1
    adaptive_temperature_target_entropy: float = 1.0
    alpha_lr: float = 1e-2
    debug: bool = False
    use_target_lst: bool = True
    loss_remove_token_mean: bool = False
    loss_remove_clip: bool = False
    sft_loss_coef: float = 1.0
    use_sft_multitask_loss: bool = False
    num_off_policy_targets: int = 2
